...
<section class="add-form py-5 text-center">
    ...
    <form class="container d-flex flex-wrap" method="POST" action="{{ route('comics.store') }}">
        ...
        <div class="col-4 d-flex flex-column align-items-center mb-3">
            ...
            <input class="p-2 text-center" type="text" id='title' name="title" value="{{ old('title') }}">
        </div>
        <div class="col-4 d-flex flex-column align-items-center mb-3">
            <label class="mb-1" for="thumb">Url compertina</label>
            <input class="p-2 text-center" type="url" id='thumb' name="thumb" value="{{ old('thumb') }}">
        </div>
        <div class="col-4 d-flex flex-column align-items-center mb-3">
            <label class="mb-1" for="series">Serie</label>
            <input class="p-2 text-center" type="text" id='series' name="series" value="{{ old('series') }}">
        </div>
        <div class="col-4 d-flex flex-column align-items-center mb-3">
            <label class="mb-1" for="type">Tipo</label>
            <input class="p-2 text-center" type="text" id='type' name="type" value="{{ old('type') }}">
        </div>
        <div class="col-4 d-flex flex-column align-items-center mb-3">
            <label class="mb-1" for="sale_date">Data pubblicazione</label>
            <input class="p-2 text-center" type="date" id='sale_date' name="sale_date" value="{{ old('sale_date') }}">
        </div>
        <div class="col-4 d-flex flex-column align-items-center mb-3">
        ...
        <div class="col-12 d-flex flex-column align-items-center mb-3 p-3">
            ...
            <textarea class="w-100 p-2" name="description" id="description" rows="10">{{ old('description') }}</textarea>
        </div>
        <div class="col-6 d-flex flex-column align-items-center mb-3 p-3">
            <label class="mb-1" for="artists">Artisti</label>
            <textarea class="w-100 p-2" name="artists" id="artists" rows="10">{{ old('artists') }}</textarea>
        </div>
        <div class="col-6 d-flex flex-column align-items-center mb-3 p-3">
            <label class="mb-1" for="writers">Scrittori</label>
            <textarea class="w-100 p-2" name="writers" id="writers" rows="10">{{ old('writers') }}</textarea>
        </div>
